...
{ "Merchants", "商人" }, { "Oddities", "珍奇之物" },
            ...
            { "intelligence", "智力" }, { "willpower", "意志" }, { "ego", "自我" },
    ...
    private static readonly Dictionary<string, string> PhraseLeaks =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "Swift Reflexes", "迅捷反射(Swift Reflexes)" },
            { "Spry", "靈活(Spry)" },
            { "Jump", "跳躍" },
            { "Tumble", "翻滾" },
            ...
            { "Flattening Fire", "壓平火焰(Flattening Fire)" },
            { "Wounding Fire", "傷口灼燒(Wounding Fire)" },
            { "Disorienting Fire", "令人迷失方向的火焰(Disorienting Fire)" },
            { "Sure Fire", "萬無一失(Sure Fire)" },
            { "Beacon Fire", "信標之火(Beacon Fire)" },
            { "Ultra Fire", "超火(Ultra Fire)" },
            { "Meal Preparation", "膳食準備" },
            { "Harvestry", "收穫術(Harvestry)" },
            { "Butchery", "屠殺" },
            { "Spicer", "香料商(Spicer)" },
            ...
            { "Demolish", "拆除" },
            { "Tactful", "圓滑(Tactful)" },
            { "Trash Divining", "垃圾占卜(Trash Divining)" },
            ...
            { "Multiweapon Expertise", "多武器專精(Multiweapon Expertise)" },
            { "Multiweapon Mastery", "多武器精通(Multiweapon Mastery)" },
            { "Shake It Off", "擺脫負面狀態" },
            { "Swimming", "游泳" },
            { "Poison Tolerance", "毒素耐性" },
            { "Weathered", "飽經風霜(Weathered)" },
            { "Juicer", "榨汁者(Juicer)" },
            { "Calloused", "繭化(Calloused)" },
            { "Longstrider", "長步者(Longstrider)" },
            { "Staunch Wounds", "頑強傷口(Staunch Wounds)" },
            { "Nostrums", "藥劑" },
            { "Amputate Limb", "截肢" },
            { "Apothecary", "藥劑師(Apothecary)" },
            { "Strapping Shoulders", "束帶肩甲(Strapping Shoulders)" },
            { "Tank", "坦克(Tank)" },
            { "Sweep", "橫掃" },
            { "Long Blade Proficiency", "長刃精通(Long Blade Proficiency)" },
            { "Lunge", "突刺" },
            { "Swipe", "揮擊" },
            { "Dueling Stance", "決鬥架勢(Dueling Stance)" },
            { "Improved Aggressive Stance", "改良型侵略姿態(Improved Aggressive Stance)" },
            { "Improved Defensive Stance", "改良防禦姿態(Improved Defensive Stance)" },
            { "Improved Dueling Stance", "改良型決鬥架勢(Improved Dueling Stance)" },
            { "En Garde!", "小心！(En Garde!)" },
            { "Menacing Stare", "威脅凝視(Menacing Stare)" },
            { "Intimidate", "威嚇" },
            { "Berate", "斥責" },
            { "Snake Oiler", "蛇油商(Snake Oiler)" },
            { "Proselytize", "勸誘信徒(Proselytize)" },
            { "Inspiring Presence", "鼓舞人心的存在感(Inspiring Presence)" },
            { "Steady Hand", "穩定的手(Steady Hand)" },
            { "Akimbo", "雙持(Akimbo)" },
            { "Weak Spotter", "弱點偵測者(Weak Spotter)" },
            { "Sling and Run", "投石與奔跑(Sling and Run)" },
            { "Disarming Shot", "卸力射擊" },
            { "Dead Shot", "神射手(Dead Shot)" },
            { "Empty the Clips", "清空彈匣" },
            { "Fastest Gun in the Rust", "鏽蝕之地最快槍手(Fastest Gun in the Rust)" },
            { "Meditate", "冥想" },
            { "Fasting Way", "禁食之道(Fasting Way)" },
            { "Iron Mind", "鋼鐵意志(Iron Mind)" },
            { "Lionheart", "獅心(Lionheart)" },
            { "Mind over Body", "心勝於身(Mind over Body)" },
            { "Block", "格擋" },
            { "Shield Slam", "盾牌 撞擊" },
            { "Deft Blocking", "靈巧格擋" },
            { "Swift Blocking", "迅捷格擋" },
            { "Staggering Block", "踉蹌格擋" },
            { "Shield Wall", "盾牌 牆壁(Shield Wall)" },
            { "Short Blade Expertise", "短刃專精" },
            { "Bloodletter", "血刃(Bloodletter)" },
            { "Jab", "刺擊" },
            { "Hobble", "跛行" },
            { "Pointed Circle", "尖銳圓環(Pointed Circle)" },
            { "Rejoinder", "反擊" },
            { "Shank", "刺殺" },
            { "Hurdle", "跨越" },
            { "Deft Throwing", "靈巧投擲" },
            { "Charge", "衝鋒" },
            { "Kickback", "反作用力(Kickback)" },
            { "Juke", "閃躲(Juke)" },
            { "Gadget Inspector", "裝置檢查員(Gadget Inspector)" },
            { "Disassemble", "拆解" },
            { "Reverse Engineer", "逆向工程師(Reverse Engineer)" },
            { "Scavenger", "拾荒者(Scavenger)" },
            { "Repair", "修理" },
            { "Deploy Turret", "部署砲塔" },
            { "Lay Mine / Set Bomb", "佈雷 / 設置炸彈" },
            { "Tinker I", "修補匠 I(Tinker I)" },
            { "Tinker II", "修補匠 II(Tinker II)" },
            { "Tinker III", "修補匠 III(Tinker III)" },
            { "Mind's Compass", "心靈指南針(Mind's Compass)" },
    ...
    private static readonly Dictionary<string, string> TmpWords =
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            // 屬性
            { "Strength", "力量" }, { "Agility", "敏捷" }, { "Toughness", "韌性" },
            { "Willpower", "意志" }, { "Intelligence", "智力" }, { "Ego", "自我" },
            { "Speed", "速度" }, { "MoveSpeed", "移動速度" }, { "Level", "等級" }, { "Third", "第三" },
            // 技能/能力（高頻白名單）
            { "Swift Reflexes", "迅捷反射(Swift Reflexes)" }, { "Spry", "靈活(Spry)" }, { "Jump", "跳躍" },
            { "Tumble", "翻滾" }, { "Axe Proficiency", "斧頭精通" }, { "Cleave", "劈砍" },
            { "Charging Strike", "衝鋒突刺" }, { "Dismember", "肢解" },
            { "Hook and Drag", "鉤拽" }, { "Decapitate", "斬首" }, { "Berserk!", "狂暴！(Berserk!)" },
            { "Cudgel Proficiency", "棍術精通" }, { "Bludgeon", "猛擊" }, { "Conk", "敲昏" },
            { "Backswing", "回身揮擊" }, { "Slam", "猛擊" }, { "Demolish", "粉碎" },
            { "Flurry", "狂亂(Flurry)" }, { "Lunge", "突刺" }, { "Swipe", "揮斬" },
            { "Dueling Stance", "決鬥架勢(Dueling Stance)" }, { "Block", "格擋" }, { "Shield Slam", "盾牌猛擊" },
            { "Deft Blocking", "靈巧格擋" }, { "Swift Blocking", "迅捷格擋" },
            { "Staggering Block", "踉蹌格擋" }, { "Shield Wall", "盾牌 牆壁(Shield Wall)" },
            { "Jab", "刺擊" }, { "Hobble", "跛行" }, { "Shank", "捅刺" },
            { "Hurdle", "跨越" }, { "Deft Throwing", "精準投擲" }, { "Charge", "衝鋒" },
            { "Kickback", "反作用力(Kickback)" }, { "Juke", "閃躲(Juke)" }, { "Akimbo", "雙持(Akimbo)" },
            { "Disassemble", "拆解" }, { "Reverse Engineer", "逆向工程師(Reverse Engineer)" },
            { "Scavenger", "拾荒者(Scavenger)" }, { "Repair", "修理" }, { "Deploy Turret", "部署砲塔" },
            { "Tinker I", "修補匠 I(Tinker I)" }, { "Tinker II", "修補匠 II(Tinker II)" }, { "Tinker III", "修補匠 III(Tinker III)" },
            { "Meditate", "冥想" }, { "Fasting Way", "禁食之道(Fasting Way)" }, { "Iron Mind", "鋼鐵意志(Iron Mind)" },
            { "Lionheart", "獅心(Lionheart)" }, { "Conatus", "內驅力(Conatus)" }, { "Mind over Body", "心勝於身(Mind over Body)" },
            { "Proselytize", "勸誘信徒(Proselytize)" }, { "Intimidate", "恐嚇" }, { "Berate", "斥責" },
            { "Snake Oiler", "蛇油商(Snake Oiler)" }, { "Inspiring Presence", "鼓舞人心的存在感(Inspiring Presence)" },
            { "Menacing Stare", "威脅凝視(Menacing Stare)" }, { "Steady Hands", "穩手" },
            { "Suppressive Fire", "壓制射擊" },
            { "Make Camp", "紮營" }, { "Mind's Compass", "心靈指南針(Mind's Compass)" },
            { "Tomorrowful", "明日之光(Tomorrowful)" },
